...
const preencherTabela = () => {
  const recados = recuperarLocalStorage();
  corpoRecados.setAttribute("style", "color: white;");
...
<tr>
     ...
     <td> 
     <img src="./images/exxcluir.ico" alt="lixeira" class="imgs" onclick="apagarRecado(${recado.id})" />
     <img src="./images/editar.ico" alt="lixeira" class="imgs" onclick="editarRecado(${recado.id})"/>
     </td>
</tr>
     `;
  }
